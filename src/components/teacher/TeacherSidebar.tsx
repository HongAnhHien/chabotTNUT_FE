...
const CSS = `
  ...
  .tv3-logout { transition:background .14s,color .14s; }
  .tv3-logout:hover { background:rgba(239,68,68,0.07) !important; color:#ef4444 !important; }
        ...
        <div style={{
          ...
          {showExpanded ? (
            ...
            <div style={{
              ...
              <BookOpenCheck size={20} color="white" strokeWidth={2.5} />
            </div>
          )}
        </div>
        ...
        <div style={{
          ...
          {showExpanded ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
              ...
              <button className="tv3-logout" onClick={onLogout} title="Đăng xuất"
                style={{
